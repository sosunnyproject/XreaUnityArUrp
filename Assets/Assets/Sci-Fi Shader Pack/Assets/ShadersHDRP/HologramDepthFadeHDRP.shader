...
Shader "SciFI_HDRP/HologramDepthFade 1"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float2 appendResult20 = (float2(0.0 , 0.1));
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float2 appendResult14 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 panner23 = ( 1.0 * _Time.y * appendResult20 + ( appendResult14 * _UV ));
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				float fresnelNdotV17 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode17 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV17, _Power ) );
				float clampResult22 = clamp( ( 1.0 - fresnelNode17 ) , 0.0 , 1.0 );
				#ifdef _INVERT_ON
				float staticSwitch25 = clampResult22;
				#else
				float staticSwitch25 = fresnelNode17;
				#endif
				float4 temp_output_28_0 = ( tex2Dlod( _Hologram, float4( panner23, 0, 0.0) ) * staticSwitch25 );
				...
				#endif
				float3 vertexValue = ( _VertexMovement * temp_output_28_0 ).rgb;
						...
						)
			{
				...
				float2 appendResult14 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 panner23 = ( 1.0 * _Time.y * appendResult20 + ( appendResult14 * _UV ));
				float fresnelNdotV17 = dot( normalWS, normalizedWorldViewDir );
				float fresnelNode17 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV17, _Power ) );
				float clampResult22 = clamp( ( 1.0 - fresnelNode17 ) , 0.0 , 1.0 );
				#ifdef _INVERT_ON
				float staticSwitch25 = clampResult22;
				...
				float staticSwitch25 = fresnelNode17;
				#endif
				float4 temp_output_28_0 = ( tex2D( _Hologram, panner23 ) * staticSwitch25 );
				float4 screenPos = packedInput.ase_texcoord5;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth24 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth24 = abs( ( screenDepth24 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthPower ) );
				float clampResult27 = clamp( distanceDepth24 , 0.0 , 1.0 );
				float4 clampResult33 = clamp( ( temp_output_28_0 * clampResult27 ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				
				surfaceDescription.Albedo = _EmissionColor.rgb;
				...
				surfaceDescription.Alpha = clampResult33.r;
		...
		Pass
		{
					...
					)
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV17 = dot( normalWS, ase_worldViewDir );
				float fresnelNode17 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV17, _Power ) );
				float clampResult22 = clamp( ( 1.0 - fresnelNode17 ) , 0.0 , 1.0 );
				#ifdef _INVERT_ON
				float staticSwitch25 = clampResult22;
...
/*ASEBEGIN
Version=17700
0;0;1920;1019;2650.519;396.3968;1.596333;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;13;-2095.971,-87.54413;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;11;-1954.831,351.4399;Float;False;Property;_Power;Power;1;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1955.831,272.4401;Float;False;Property;_Scale;Scale;0;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;17;-1750.518,264.9808;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;14;-1840.987,-64.15754;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1850.109,38.56276;Float;False;Property;_UV;UV;6;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1858.101,131.8532;Float;False;Constant;_Panner;Panner;5;0;Create;True;0;0;False;0;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;20;-1623.221,53.75938;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-1625.019,-66.05663;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.OneMinusNode;18;-1481.621,363.9553;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1312.045,566.3923;Float;False;Property;_DepthPower;DepthPower;3;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;23;-1428.852,-66.00513;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0.1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ClampOpNode;22;-1290.997,364.7589;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;26;-1191.695,-94.11963;Inherit;True;Property;_Hologram;Hologram;4;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DepthFade;24;-1092.105,548.9706;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;25;-1103.922,261.6552;Float;False;Property;_Invert;Invert;5;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;27;-797.1185,548.0596;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-767.4788,126.6895;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-542.9448,317.4364;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-624.1763,40.28648;Float;False;Property;_VertexMovement;VertexMovement;7;0;Create;True;0;0;False;0;0.02;0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;33;-329.1424,318.7328;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-315.0915,101.5393;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;31;-539.5981,-381.0057;Float;False;Property;_EmissionColor;EmissionColor;2;2;[HDR];[Gamma];Create;True;0;0;False;0;0,0,0,0;0.6886792,0.6604874,0.1721698,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;0,0;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;SciFI_HDRP/HologramDepthFade 1;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;0;False;False;False;True;0;True;-23;False;True;True;0;True;-12;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-13;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;29;Surface Type;1;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;1;  Z Test;4;Double-Sided;0;Alpha Clipping;0;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Specular AA;0;Specular Occlusion Mode;0;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;8;0,0;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;1;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;True;-23;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;0
...
ASEEND*/
//CHKSM=A2E6679B9C407659C54FF35F9D1AC9EAD598D49F