...
Shader "SciFI_HDRP_noGlobal/DissolveHDRP"
{
	Properties
	{
		...
		_DissolvePower("DissolvePower", Float) = 0.05
		_OpacityPower("OpacityPower", Float) = 0.012
		[HDR][Gamma]_DissolveColor("DissolveColor", Color) = (0.6179863,14.75442,0,0)
		_Smoothness("Smoothness", Range( 0 , 1)) = 0
		_ShaderDissolve("_ShaderDissolve", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_DissolveNoise = packedInput.ase_texcoord5.xy * _DissolveNoise_ST.xy + _DissolveNoise_ST.zw;
				float4 tex2DNode14 = tex2D( _DissolveNoise, uv_DissolveNoise );
				float temp_output_13_0 = (1.0 + (_ShaderDissolve - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float4 temp_output_26_0 = ( _DissolveColor * ( 1.0 - step( tex2DNode14.r , ( temp_output_13_0 + _DissolvePower ) ) ) );
				float4 lerpResult32 = lerp( ( tex2D( _Emission, uv_Emission ) * _EmissionColor ) , temp_output_26_0 , temp_output_26_0);
				
				float2 uv_AO = packedInput.ase_texcoord5.xy * _AO_ST.xy + _AO_ST.zw;
				
				float clampResult27 = clamp( step( tex2DNode14.r , ( temp_output_13_0 + _OpacityPower ) ) , 0.0 , 1.0 );
				
				surfaceDescription.Albedo = tex2DNode30.rgb;
				surfaceDescription.Normal = UnpackNormalmapRGorAG( tex2D( _Normal, uv_Normal ), _NoisePower );
				...
				surfaceDescription.Emission = lerpResult32.rgb;
				surfaceDescription.Smoothness = _Smoothness;
				surfaceDescription.Occlusion = tex2D( _AO, uv_AO ).r;
				surfaceDescription.Alpha = ( tex2DNode30.a * clampResult27 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_DissolveNoise = packedInput.ase_texcoord.xy * _DissolveNoise_ST.xy + _DissolveNoise_ST.zw;
				float4 tex2DNode14 = tex2D( _DissolveNoise, uv_DissolveNoise );
				float temp_output_13_0 = (1.0 + (_ShaderDissolve - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float4 temp_output_26_0 = ( _DissolveColor * ( 1.0 - step( tex2DNode14.r , ( temp_output_13_0 + _DissolvePower ) ) ) );
				float4 lerpResult32 = lerp( ( tex2D( _Emission, uv_Emission ) * _EmissionColor ) , temp_output_26_0 , temp_output_26_0);
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode30 = tex2D( _Albedo, uv_Albedo );
				float2 uv_DissolveNoise = packedInput.ase_texcoord1.xy * _DissolveNoise_ST.xy + _DissolveNoise_ST.zw;
				float4 tex2DNode14 = tex2D( _DissolveNoise, uv_DissolveNoise );
				float temp_output_13_0 = (1.0 + (_ShaderDissolve - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult27 = clamp( step( tex2DNode14.r , ( temp_output_13_0 + _OpacityPower ) ) , 0.0 , 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode30 = tex2D( _Albedo, uv_Albedo );
				float2 uv_DissolveNoise = packedInput.interp03.xy * _DissolveNoise_ST.xy + _DissolveNoise_ST.zw;
				float4 tex2DNode14 = tex2D( _DissolveNoise, uv_DissolveNoise );
				float temp_output_13_0 = (1.0 + (_ShaderDissolve - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult27 = clamp( step( tex2DNode14.r , ( temp_output_13_0 + _OpacityPower ) ) , 0.0 , 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode30 = tex2D( _Albedo, uv_Albedo );
				float2 uv_DissolveNoise = packedInput.ase_texcoord3.xy * _DissolveNoise_ST.xy + _DissolveNoise_ST.zw;
				float4 tex2DNode14 = tex2D( _DissolveNoise, uv_DissolveNoise );
				float temp_output_13_0 = (1.0 + (_ShaderDissolve - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult27 = clamp( step( tex2DNode14.r , ( temp_output_13_0 + _OpacityPower ) ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=17700
-1913;7;1906;1005;4319.567;507.6568;2.043324;True;False
Node;AmplifyShaderEditor.RangedFloatNode;11;-2016.663,1075.54;Float;False;Property;_ShaderDissolve;_ShaderDissolve;10;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;13;-1698.633,1081.747;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;-0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-1772.345,932.1331;Float;False;Property;_DissolvePower;DissolvePower;6;0;Create;True;0;0;False;0;0.05;0.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;15;-1468.083,913.8641;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1316.565,1080.19;Float;False;Property;_OpacityPower;OpacityPower;7;0;Create;True;0;0;False;0;0.012;0.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;14;-1638.255,684.631;Inherit;True;Property;_DissolveNoise;DissolveNoise;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;17;-1180.014,608.2431;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-1070.059,906.9651;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;18;-1030.151,312.7785;Float;False;Property;_DissolveColor;DissolveColor;8;2;[HDR];[Gamma];Create;True;0;0;False;0;0.6179863,14.75442,0,0;0.1801879,4.594795,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;21;-1023.633,20.7542;Inherit;False;Property;_EmissionColor;EmissionColor;5;2;[HDR];[Gamma];Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StepOpNode;24;-769.9044,718.4011;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;20;-970.3659,502.9391;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;22;-1053.001,-182.1424;Inherit;True;Property;_Emission;Emission;4;0;Create;True;0;0;False;0;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;30;-780.3462,-605.5778;Inherit;True;Property;_Albedo;Albedo;1;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;27;-489.7164,608.6942;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-997.8475,-331.9258;Inherit;False;Property;_NoisePower;NoisePower;12;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-570.8333,-24.04591;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-664.1142,373.6311;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;33;-783.5878,116.7357;Inherit;True;Property;_AO;AO;3;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;29;-362.3195,323.4294;Float;False;Property;_Smoothness;Smoothness;9;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-211.6304,438.7237;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-352.2955,231.7689;Inherit;False;Property;_Metallic;Metallic;11;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;31;-781.0545,-370.6206;Inherit;True;Property;_Normal;Normal;2;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;32;-254.0334,-11.2458;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;0,0;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;12;SciFI_HDRP_noGlobal/DissolveHDRP;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;True;0;True;-23;False;True;True;0;True;-12;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-13;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;29;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;0;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Specular AA;0;Specular Occlusion Mode;0;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;0
...
WireConnection;0;6;32;0
WireConnection;0;7;29;0
WireConnection;0;8;33;0
WireConnection;0;9;34;0
ASEEND*/
//CHKSM=58AD884214C462F655CE0752AEFEE17F288DEF9E