...
Shader "SciFI_HDRP_noGlobal/DisplacementHDRP"
{
	Properties
	{
		...
		_ObjectHigh("ObjectHigh", Float) = 1.2
		_ObjectLow("ObjectLow", Float) = -0.8
		_ShaderDisplacement("_ShaderDisplacement", Range( 0 , 1)) = 0
		_NormalPower("NormalPower", Float) = 0
		[HDR][Gamma]_DispEmissionColor("DispEmissionColor", Color) = (0,0,0,0)
		[HDR][Gamma]_EmissionColor("EmissionColor", Color) = (3.057891,2.242453,33.43294,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float temp_output_19_0 = ( 0.0 + (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) );
				float vpY17 = inputMesh.positionOS.y;
				float temp_output_32_0 = ( temp_output_19_0 - vpY17 );
				float clampResult37 = clamp( temp_output_32_0 , 0.0 , temp_output_32_0 );
				float4 appendResult50 = (float4(0.0 , ( ( inputMesh.normalOS.y * 0.02 ) + clampResult37 ) , 0.0 , 0.0));
				float smoothstepResult46 = smoothstep( ( temp_output_19_0 - 0.2 ) , ( temp_output_19_0 + 0.2 ) , vpY17);
				...
				#endif
				float3 vertexValue = ( appendResult50 * smoothstepResult46 ).xyz;
						...
						)
			{
				...
				float temp_output_19_0 = ( 0.0 + (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) );
				float vpY17 = packedInput.ase_texcoord6.xyz.y;
				float smoothstepResult25 = smoothstep( ( temp_output_19_0 - 0.5 ) , ( temp_output_19_0 + 0.5 ) , vpY17);
				float4 lerpResult47 = lerp( ( tex2DNode35 * _AlbedoColor ) , float4( 0,0,0,0 ) , smoothstepResult25);
				
				float2 uv_Normal = packedInput.ase_texcoord5.xy * _Normal_ST.xy + _Normal_ST.zw;
				
				float4 lerpResult27 = lerp( float4( 0,0,0,0 ) , _DispEmissionColor , smoothstepResult25);
				...
				float4 clampResult42 = clamp( ( tex2DNode28 / lerpResult27 ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float grayscale49 = Luminance(clampResult42.rgb);
				float4 lerpResult56 = lerp( lerpResult27 , ( tex2DNode28 * _EmissionColor ) , grayscale49);
				
				float2 uv_AO = packedInput.ase_texcoord5.xy * _AO_ST.xy + _AO_ST.zw;
				
				surfaceDescription.Albedo = lerpResult47.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode35 = tex2D( _Albedo, uv_Albedo );
				float temp_output_19_0 = ( 0.0 + (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) );
				float vpY17 = packedInput.ase_texcoord1.xyz.y;
				float smoothstepResult25 = smoothstep( ( temp_output_19_0 - 0.5 ) , ( temp_output_19_0 + 0.5 ) , vpY17);
				float4 lerpResult47 = lerp( ( tex2DNode35 * _AlbedoColor ) , float4( 0,0,0,0 ) , smoothstepResult25);
...
/*ASEBEGIN
Version=17700
-1913;7;1906;1005;4150.505;211.0555;1.192785;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-3162.709,645.7511;Float;False;Property;_ShaderDisplacement;_ShaderDisplacement;9;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-3048.96,722.5148;Float;False;Property;_ObjectLow;ObjectLow;8;0;Create;True;0;0;False;0;-0.8;-1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-3026.156,811.7096;Float;False;Property;_ObjectHigh;ObjectHigh;7;0;Create;True;0;0;False;0;1.2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;14;-3170.538,-146.9218;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;17;-2884.823,-107.1838;Float;False;vpY;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-2761.649,548.6616;Inherit;False;Constant;_Const;Const;12;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;16;-2771.276,652.483;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;-2502.656,630.1235;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-2371.617,-4.806702;Float;False;Constant;_Float0;Float 0;5;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;20;-2719.111,239.5693;Inherit;False;17;vpY;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;22;-2080.572,-80.10971;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;21;-2302.162,-128.1377;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;23;-2083.335,54.39587;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;26;-2329.98,396.1967;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;25;-1764.495,-59.4845;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;62;-1772.827,-294.3005;Inherit;False;Property;_DispEmissionColor;DispEmissionColor;11;2;[HDR];[Gamma];Create;True;0;0;False;0;0,0,0,0;166.9272,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;28;-1397.506,-317.6112;Inherit;True;Property;_Emission;Emission;6;0;Create;True;0;0;False;0;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;30;-2529.941,747.8337;Float;False;Constant;_Const1;Const1;5;0;Create;True;0;0;False;0;0.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;32;-2090.124,491.2769;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;27;-1469.902,-107.7221;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-2113.925,389.3969;Float;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;False;0;0.02;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;31;-2133.681,216.4859;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;39;-1112.527,73.50729;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;-2236.066,730.5271;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;40;-2070.432,675.653;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;33;-2254.811,620.1557;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;37;-1873.127,491.7548;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-1875.853,310.2686;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;42;-932.9515,107.8608;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;35;-1672.231,-1011.088;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;64;-1255.195,-556.5745;Inherit;False;Property;_EmissionColor;EmissionColor;12;2;[HDR];[Gamma];Create;True;0;0;False;0;3.057891,2.242453,33.43294,0;36.75834,30.0078,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;45;-1683.286,385.76;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;46;-2010.786,683.7767;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;36;-1578.345,-800.8613;Float;False;Property;_AlbedoColor;AlbedoColor;1;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;50;-1490.41,362.6621;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.WireNode;48;-1488.349,647.4088;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;52;-915.4672,-200.8114;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-1255.643,-819.8443;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;43;-1362.853,-574.259;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-918.4468,-318.6201;Inherit;False;Property;_NormalPower;NormalPower;10;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCGrayscale;49;-749.236,117.9631;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;55;-1252.355,363.4339;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-390.4832,218.6717;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;60;-405.2619,315.2202;Float;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;47;-989.6019,-744.0922;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;57;-645.8301,-211.8935;Inherit;True;Property;_Normal;Normal;4;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;59;-2886.052,-17.3508;Float;False;vpZ;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;56;-502.6805,45.62408;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;53;-435.6457,454.6313;Inherit;True;Property;_AO;AO;5;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;58;-2886.03,-197.8039;Float;False;vpX;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
