...
Shader "SciFI_HDRP/HologramHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				float2 appendResult19 = (float2(0.0 , 0.1));
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float2 appendResult16 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 panner22 = ( 1.0 * _Time.y * appendResult19 + ( appendResult16 * _UV ));
				...
				float clampResult21 = clamp( ( 1.0 - fresnelNode17 ) , 0.0 , 1.0 );
				#ifdef _INVERT_ON
				float staticSwitch24 = clampResult21;
				#else
				float staticSwitch24 = fresnelNode17;
				#endif
				float4 temp_output_26_0 = ( tex2Dlod( _Hologram, float4( panner22, 0, 0.0) ) * staticSwitch24 );
				...
				#endif
				float3 vertexValue = ( temp_output_26_0 * _VertexMovement ).rgb;
						...
						)
			{
				...
				float staticSwitch24 = fresnelNode17;
				#endif
				float4 temp_output_26_0 = ( tex2D( _Hologram, panner22 ) * staticSwitch24 );
				float4 clampResult29 = clamp( temp_output_26_0 , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				...
				surfaceDescription.Alpha = clampResult29.r;
...
/*ASEBEGIN
Version=17800
640;155;1025;571;1204.308;309.1249;1.52887;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;13;-2013.063,165.8443;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;12;-2093.595,583.6791;Float;False;Property;_Power;Power;1;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-2094.595,504.6792;Float;False;Property;_Scale;Scale;0;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1775.193,390.2417;Float;False;Constant;_Panner;Panner;5;0;Create;True;0;0;False;0;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;17;-1889.281,497.2199;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1767.2,291.9512;Float;False;Property;_UV;UV;5;0;Create;True;0;0;False;0;1;3.73;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;16;-1758.078,189.2309;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;19;-1540.313,307.1478;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.OneMinusNode;18;-1620.385,596.1945;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-1542.11,187.3318;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ClampOpNode;21;-1429.76,596.9982;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;22;-1345.943,187.3833;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0.1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;23;-1108.786,159.2688;Inherit;True;Property;_Hologram;Hologram;3;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;24;-1242.685,493.8943;Float;False;Property;_Invert;Invert;4;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-731.4756,163.977;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-761.9287,294.8942;Float;False;Property;_VertexMovement;VertexMovement;6;0;Create;True;0;0;False;0;0.02;0.005;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;29;-320.8525,165.0657;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-492.9285,276.8942;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;27;-432.0887,-45.14989;Float;False;Property;_EmissionColor;EmissionColor;2;2;[HDR];[Gamma];Create;True;0;0;False;0;0,0,0,0;1.605559,1.529904,0.1008728,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=70DCF974959EA696DC842DD545C9EECE2AE98A84