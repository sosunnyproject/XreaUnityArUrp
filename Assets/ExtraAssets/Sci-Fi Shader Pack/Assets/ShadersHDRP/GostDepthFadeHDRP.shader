...
Shader "SciFI_HDRP/GostDepthFadeHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float fresnelNdotV13 = dot( normalWS, normalizedWorldViewDir );
				float fresnelNode13 = ( 0.0 + _Scale1 * pow( 1.0 - fresnelNdotV13, _Power1 ) );
				float clampResult17 = clamp( ( 1.0 - fresnelNode13 ) , 0.0 , 1.0 );
				#ifdef _INVERT1_ON
				float staticSwitch19 = clampResult17;
				#else
				float staticSwitch19 = fresnelNode13;
				#endif
				float4 screenPos = packedInput.ase_texcoord5;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth16 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth16 = abs( ( screenDepth16 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthPower ) );
				float clampResult18 = clamp( distanceDepth16 , 0.0 , 1.0 );
				float clampResult22 = clamp( ( staticSwitch19 * clampResult18 ) , 0.0 , 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV13 = dot( normalWS, ase_worldViewDir );
				float fresnelNode13 = ( 0.0 + _Scale1 * pow( 1.0 - fresnelNdotV13, _Power1 ) );
				float clampResult17 = clamp( ( 1.0 - fresnelNode13 ) , 0.0 , 1.0 );
				#ifdef _INVERT1_ON
				float staticSwitch19 = clampResult17;
...
/*ASEBEGIN
Version=17700
0;0;1920;1019;1845.198;474.9016;1.324338;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-1402.388,195.0222;Float;False;Property;_Power1;Power;1;0;Create;True;0;0;False;0;1;0.84;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-1403.388,116.0223;Float;False;Property;_Scale1;Scale;0;0;Create;True;0;0;False;0;1;2.37;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;13;-1198.074,108.5629;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1074.033,364.0687;Float;False;Property;_DepthPower;DepthPower;3;0;Create;True;0;0;False;0;0;5.27;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;15;-946.9552,195.1906;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;17;-784.9371,195.0286;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;16;-855.0924,344.647;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;19;-618.9434,102.7028;Float;False;Property;_Invert1;Invert;4;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;18;-560.1057,343.7359;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-366.3828,180.0464;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;22;-170.4227,181.582;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;21;-381.1985,-92.90704;Float;False;Property;_EmissionColor;EmissionColor;2;2;[HDR];[Gamma];Create;True;0;0;False;0;0,0,0,0;0.4308014,1.429,1.429,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4413D36B64B487ACCD1EFA1CFBA491BFE81A189F