...
Shader "SciFI_HDRP/HologramFresnelColorHDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 panner22 = ( 1.0 * _Time.y * appendResult20 + ( appendResult18 * _UV ));
				float fresnelNdotV14 = dot( normalWS, normalizedWorldViewDir );
				float fresnelNode14 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV14, _Power ) );
				float clampResult21 = clamp( ( 1.0 - fresnelNode14 ) , 0.0 , 1.0 );
				#ifdef _INVERT_ON
				float staticSwitch23 = clampResult21;
				#else
				float staticSwitch23 = fresnelNode14;
				#endif
				float clampResult24 = clamp( staticSwitch23 , 0.0 , 1.0 );
				float4 temp_output_27_0 = ( tex2D( _Hologram, panner22 ) * clampResult24 );
				float4 lerpResult31 = lerp( ( _FirstColor * temp_output_27_0 ) , ( _SecondColor * temp_output_27_0 ) , clampResult24);
				...
				surfaceDescription.Emission = lerpResult31.rgb;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_27_0.r;
		...
		Pass
		{
					...
					)
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV14 = dot( normalWS, ase_worldViewDir );
				float fresnelNode14 = ( 0.0 + _Scale * pow( 1.0 - fresnelNdotV14, _Power ) );
				float clampResult21 = clamp( ( 1.0 - fresnelNode14 ) , 0.0 , 1.0 );
				#ifdef _INVERT_ON
				float staticSwitch23 = clampResult21;
...
/*ASEBEGIN
Version=17800
640;155;1025;571;1361.071;449.1061;1.700033;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-2393.312,569.6616;Float;False;Property;_Scale;Scale;0;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-2392.312,648.6614;Float;False;Property;_Power;Power;1;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;14;-2188,562.2023;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;13;-2178.91,205.9078;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;15;-1933.049,332.0148;Float;False;Property;_UV;UV;6;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;17;-1919.102,661.1768;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1941.041,430.3054;Float;False;Constant;_Panner;Panner;5;0;Create;True;0;0;False;0;0.1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;18;-1923.927,229.2943;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;20;-1706.16,347.2115;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ClampOpNode;21;-1728.478,661.9803;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-1707.958,227.3953;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.StaticSwitch;23;-1541.403,558.8767;Float;False;Property;_Invert;Invert;5;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;22;-1511.791,227.4468;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0.1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ClampOpNode;24;-1235.65,563.0009;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;25;-1274.634,199.3324;Inherit;True;Property;_Hologram;Hologram;4;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;28;-976.3772,-64.28209;Float;False;Property;_SecondColor;SecondColor;3;2;[HDR];[Gamma];Create;True;0;0;False;0;0,0,0,0;13.18071,10.75976,51.37788,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;26;-974.5752,-259.8163;Float;False;Property;_FirstColor;FirstColor;2;2;[HDR];[Gamma];Create;True;0;0;False;0;0,0,0,0;7.377211,5.214259,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-897.3252,204.0405;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-575.4839,70.95004;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-630.3073,-104.4913;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;31;-269.3707,30.1301;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
WireConnection;0;6;31;0
WireConnection;0;9;27;0
ASEEND*/
//CHKSM=DBF99C4C6EF9060CB80F4B85CD32BB6E5B971315